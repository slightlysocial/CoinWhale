<?
		...
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2>Thanks, confirm your registration to be entered.</h2></div>";
		}
		else if($message==3)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Hey now now, don't you know, that's not reeeeally an ee-mail address</h2></div>";
		}else if($message==2)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Email address already in use</h2></div>";
		}
		
		if($gift_status==1)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Success!  You have received your gift. Make sure to thank the sender.</h2></div>";
		}else if($gift_status==2)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Sorry! This activation code is not valid. For more information please contact <a href='mailto:support@coinwhale.com'>support@coinwhale.com</a></h2></div>";
		}else if($gift_status==3)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Sorry! This activation code has already been redeemed. For more information please contact <a href='mailto:support@coinwhale.com'>support@coinwhale.com</a></h2></div>";
		}else if($gift_status==4)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>You have already received this bundle. You can't have same bundle more than once.</h2></div>";
		}else if($gift_status==5)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Please login to claim your gift.</h2></div>";
		}else if($gift_status==6)
		{
			echo "<div>&nbsp;</div>";
			echo "<div align='center'><h2 style='color:#ff0000'>Oops, you can't receive gift from yourself, but from your friends!</h2></div>";
		}
?>
          ...
          }else if($user_status==2)
		  {
            ...
            $(document).ready(function() {
                $.fancybox({
					...
					'transitionOut'		: 'none',
					'type'						: 'iframe',
                    'href'              : '<?=base_url()."ajax/showpopupmerge/?email=$email"?>'
                });
